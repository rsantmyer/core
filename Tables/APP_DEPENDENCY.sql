...
, VERSION_MIN       NUMBER(12,0) DEFAULT 0            NOT NULL
, VERSION_MAX       NUMBER(12,0) DEFAULT 999999999999 NOT NULL
...
, CONSTRAINT APP_DEPENDENCY_CK3 CHECK (VERSION_MAX <= 999999999999)
...
COMMENT ON COLUMN APP_DEPENDENCY.VERSION_MIN      IS 'Default 0. Serialized semantic version from pkg_application.serialize_version_f';
COMMENT ON COLUMN APP_DEPENDENCY.VERSION_MAX      IS 'Default 999999999999. Serialized semantic version from pkg_application.serialize_version_f';
