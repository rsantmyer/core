...
PAUSE The table APP_OBJECT_METADATA will be replaced. Any data in this table will be lost. Press RETURN to continue.
...
--Table Alters
Prompt Dropping APP_OBJECT_METADATA
EXEC pkg_application.drop_object_p(ip_object_name => 'APP_OBJECT_METADATA' , ip_object_type => pkg_application.c_object_type_table);

@@../Tables/APP_OBJECT_METADATA.sql 
